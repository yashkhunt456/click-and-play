class PaymentsController < ApplicationController
  ...
  def new
    ...
    @payment = @booking.build_payment(amount: @booking.total_price, status: "pending")
  end

  def create
    @payment = @booking.payment || @booking.build_payment(amount: @booking.total_price, status: "pending") # Create new payment if it doesn't exist
    ...
    begin
      ...
      redirect_to boxhouse_box_booking_path(@boxhouse, @box, @booking), notice: "Payment successful!"
